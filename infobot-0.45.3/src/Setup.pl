...
# so that it overrides anything they might set.
    ...
    @welcomes = ('no problem', 'my pleasure', 'sure thing',
		 ...
		 'anything for you', 'I would do anything for you');
    ...
    @dunno = ('i don\'t know', 
	      ...
	      'stop asking me that',
	      'what am i, a bot',
	      'for the last time, i am not talking to you anymore',
	      'bugger all, i dunno',
	      'go away and leave me alone',
	      'what do I look like?',
              'hey, i\'m just here for the fish',
	      'Why don\'t you say something witty?',
	       "next time, try asking someone who cares...",
	       'why don\'t you try Wikipedia next time?',
